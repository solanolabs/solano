...
SAMPLE_ACCOUNT_HANDLE = "some_account"
SAMPLE_ACCOUNT_HANDLE_2 = "another_account"
...
SAMPLE_REPORT_URL = "http://ci.predix.io/1/sessions/1/test_executions/report"
...
SAMPLE_USER_RESPONSE_2 = {"status"=>0, "user"=>
  { "id" => SAMPLE_USER_ID,
    ...
    "all_accounts" => [
      ...
      { "account" => SAMPLE_ACCOUNT_HANDLE_2,
        "account_id" => SAMPLE_ACCOUNT_ID_2,
        "recurly_url" => SAMPLE_RECURLY_URL_2}]}}
